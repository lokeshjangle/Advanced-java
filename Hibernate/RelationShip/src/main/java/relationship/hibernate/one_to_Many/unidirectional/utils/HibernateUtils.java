package relationship.hibernate.one_to_Many.unidirectional.utils;
...
public class HibernateUtils {
    ...
    public static SessionFactory getSessionFactory(){
        ...
        config.addAnnotatedClass(CricketPlayer.class);
        config.addAnnotatedClass(CricketTeam.class);//Registers this entity class with Configuration
